...
const opioidLibraryNumber = 11;
    ...
    function createURL(){
        if(opioidLibraryNumber === 10){
            return 'http://cqf-ruler.localhost/cqf-ruler-r4/cds-services/opioidcds-10-patient-view';
        }
        if(opioidLibraryNumber === 11){
            return 'http://cqf-ruler.localhost/cqf-ruler-r4/cds-services/opioidcds-11-patient-view'
        }
    }
