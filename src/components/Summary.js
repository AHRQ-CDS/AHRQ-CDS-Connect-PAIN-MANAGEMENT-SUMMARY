      ...
      <div className="summary">
        ...
        <div className="summary__display">
          ...
          <div className="cdc-disclaimer">
            Please see the <i>CDC Guideline for Prescribing Opioids for Chronic Pain</i> for additional information
            and prescribing guidance: <strong>https://www.cdc.gov/mmwr/volumes/65/rr/rr6501e1.htm</strong>
          </div>
